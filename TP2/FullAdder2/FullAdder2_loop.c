/********
* ec2c version 0.68
* c main file generated for node : FullAdder2 
...
/* Output procedures **********************/
#ifdef CKCHECK
void FullAdder2_BOT_sum(void* cdata){
   _put_bottom("sum");
}
void FullAdder2_BOT_carry(void* cdata){
   _put_bottom("carry");
}
#endif
/* Output procedures **********************/
void FullAdder2_O_sum(void* cdata, _boolean _V) {
   _put_bool("sum", _V);
}
void FullAdder2_O_carry(void* cdata, _boolean _V) {
   _put_bool("carry", _V);
}/* Main procedure *************************/
int main(){
   ...
   int s = 0;
   /* Context allocation */
   struct FullAdder2_ctx* ctx = FullAdder2_new_ctx(NULL);
   ...
   while(1){
      ...
      fflush(stdout);
      ++s;
      FullAdder2_I_a(ctx, _get_bool("a"));
      FullAdder2_I_b(ctx, _get_bool("b"));
      FullAdder2_I_c(ctx, _get_bool("c"));
      FullAdder2_step(ctx);
